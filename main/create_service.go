...
func createDriverService(app *v1beta2.SparkApplication, serviceSelectorLabels map[string]string, kubeClient ctrlClient.Client, createdApplicationId string, serviceName string) error {
	...
	driverPodService := &apiv1.Service{
		...
		Spec: apiv1.ServiceSpec{
			...
			Ports: []apiv1.ServicePort{
				{
					Name:     DriverPortName,
					Port:     getDriverNBlockManagerPort(app, DriverPortProperty, DefaultDriverPort),
					Protocol: Protocol,
...
func getDriverPodBlockManagerPort(app *v1beta2.SparkApplication) int32 {
	if checkSparkConf(app.Spec.SparkConf, DriverBlockManagerPortProperty) {
		return getDriverNBlockManagerPort(app, DriverBlockManagerPortProperty, DefaultBlockManagerPort)
	}
	return DefaultBlockManagerPort
}

func getDriverNBlockManagerPort(app *v1beta2.SparkApplication, portConfig string, defaultPort int32) int32 {
	if checkSparkConf(app.Spec.SparkConf, portConfig) {
